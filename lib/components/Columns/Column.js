...
export default class {
    ...
    renderHeaderCell(grid) {
        ...
        return (
            <th draggable key={this.name} className={cls} 
                style={cellStyle} onDragStart={handleDragStart} onDrop={handleDrop}
    ...
    renderStackedHeader(grid) {
        ...
        return (
            <th className="datagrid__header__cell datagrid__cell datagrid__cell_stacked" colSpan={cols} style={cellStyle}>
