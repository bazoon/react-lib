            ...
            <div className="tab__menu">
                {
                    this.props.panes.map((pane, index) => {
                        const className = cn('tab__menu-item', {
                            ...
                            'tab__menu-item_disabled': pane.isDisabled
                        });

                        return pane.isDisabled ? 
                            <a href="#" key={index} className={className}>{pane.menuItem}</a> 
                            :
                            <a href="#" key={index} className={className} onClick={this.handleMenuItemClick.bind(this, index)}>{pane.menuItem}</a> 
                    })
                }
            </div>
        );
