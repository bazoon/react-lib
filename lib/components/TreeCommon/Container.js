...
export default (Grid, EditWindow, extensions) => class Container extends Component {
    ...
    applyPermissions() {
        ...
        if (extensions && typeof extensions.applyPermissions === 'function') {
            state = extensions.applyPermissions(permissions, this.state);
        } 
    ...
    render() {
        return (
            <div className="theme-white" style={{ backgroundColor:'white', width: '950px', margin: '20px'}}>
